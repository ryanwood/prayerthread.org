...
describe AnnouncementsController do
  ...
  def mock_announcement(stubs={})
    (@mock_announcement ||= mock_model(Announcement).as_null_object).tap do |announcement|
      announcement.stub(stubs) unless stubs.empty?
    end
  end
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested announcement" do
        Announcement.should_receive(:find).with("37") { mock_announcement }
